                        ...
                        <?php
                          $db_handle->prepareStatement(
                              "SELECT
                                ...
                                FROM `edithistories`
                                JOIN users
                                    ON users.UserID = edithistories.ActiveUserID
                                WHERE EditItemID = :id
                                    AND EditType = 'Assessment Tool Layout'
                        ...
                        <div class="modal-body">
                            ...
                            foreach($editHistory as $entry) {
                                ...
                                echo date( 'M d, Y <\b\r> h:i a', $phpdate );
                                        ...
                                        <td><h6><?php echo($entry["EditDescription"]); ?></h6></td>
                                    </tr>
                                    <?php
                            }
                                    ?>
                    ...
                    <div class="item">  <!--Edit History-->
                        ...
                        if($editing === "title") {
                            $db_handle->prepareStatement(
                                ...
                                WHERE EditItemID = :id
                                    AND EditType = 'Assessment Tool Layout'
                                ORDER BY EditDate DESC LIMIT 10;"
                            );
                            $db_handle->bindVar(':id', $id, PDO::PARAM_INT,0);
                            $editHistory = $db_handle->runFetch();
                        } else if ($editing === "instr") {
                            ...
                            <div>
                                ...
                                <table align="left" cellspacing="3" cellpadding="3" width="75%" class="table table-hover">
                                    ...
                                    <tr>
                                        <td><h6>
                                            <?php
                                            $phpdate = strtotime( $entry["EditDate"] );
                                            echo date( 'M d, Y <\b\r> h:i a', $phpdate );
                                            ?>
                                            </h6></td>
                                        <td><h6><?php echo($entry["Name"]); ?></h6></td>
